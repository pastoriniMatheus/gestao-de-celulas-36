    ...
    return <div className="flex flex-col h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 overflow-hidden">
        ...
        <div className="flex-shrink-0 bg-white/95 backdrop-blur-lg border-b border-pink-200 shadow-sm">
          <div className="p-3">
            ...
            {/* Menu Horizontal Deslizante com Carousel - Botões maiores */}
                  ...
                  {menuItems.map(item => 
                    <CarouselItem key={item.value} className="pl-2 basis-auto">
                      <button 
                        ...
                        className={`flex flex-col items-center gap-2 px-4 py-3 rounded-xl border-2 transition-all duration-300 text-sm whitespace-nowrap min-w-[80px] ${
        ...
        {/* Conteúdo das Tabs - Ocupa o resto da altura sem scroll horizontal */}
        <div className="flex-1 min-h-0 overflow-hidden">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            <TabsContent value="children" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-pink-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-pink-500 to-purple-600 p-3 flex-shrink-0 rounded-t-xl">
            ...
            <TabsContent value="schedule" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-blue-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
            ...
            <TabsContent value="lessons" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-green-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
            ...
            <TabsContent value="record" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-orange-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-orange-500 to-red-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
            ...
            <TabsContent value="history" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-purple-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
            ...
            <TabsContent value="chart" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-teal-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-teal-500 to-cyan-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
            ...
            <TabsContent value="notifications" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-rose-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-rose-500 to-pink-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
            ...
            <TabsContent value="materials" className="flex-1 m-0 p-3 overflow-hidden">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-slate-200 h-full flex flex-col overflow-hidden">
                <div className="bg-gradient-to-r from-slate-500 to-gray-600 p-3 flex-shrink-0 rounded-t-xl">
                  <div className="flex items-center gap-2">
                    <div className="w-4 h-4 bg-white/30 rounded-full flex items-center justify-center">
