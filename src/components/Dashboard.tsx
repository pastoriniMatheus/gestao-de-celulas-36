...
import { BarChart3, Users, Home, Calendar, QrCode } from 'lucide-react';
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{qrLoading ? '...' : activeQRCodes}</div>
                <p className="text-xs text-muted-foreground">
                  {totalScans} scans no total
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">Crie QR codes para eventos e campanhas</span>
                  </div>
                  <div className="flex items-center space-x-2">
