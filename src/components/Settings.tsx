      ...
      <Card className="bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
        <CardHeader>
          <CardTitle className="flex items-center gap-3 text-2xl">
            {configLoading ? <div className="w-8 h-8 bg-gray-200 rounded animate-pulse"></div> : logoUrl ? <img src={logoUrl} alt={logoAlt} className="w-8 h-8 object-contain rounded border border-purple-200" onError={e => {
