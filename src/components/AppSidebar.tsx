...
export function AppSidebar() {
  ...
  return <Sidebar className="border-r border-gray-200 bg-gradient-to-b from-gray-50 to-white">
      <SidebarContent>
        <SidebarGroup>
            ...
            <SidebarMenu className="space-y-1">
              ...
              return <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild isActive={isActive} className={`
                        ...
                        ${isActive ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md transform scale-105' : `${item.bgColor} ${item.color} hover:shadow-sm hover:transform hover:scale-[1.02]`}
                      ...
                      <Link to={item.url} className="flex items-center w-full">
                        ...
                        {isActive && <div className="absolute right-2 w-2 h-2 bg-white rounded-full opacity-75"></div>}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>;
            })}
        ...
        <div className="mt-auto p-4">
          <div className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg p-3 border border-blue-200 py-0 px-0">
