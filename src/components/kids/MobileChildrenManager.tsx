          ...
          <div className="space-y-2">
            ...
            {formData.has_food_restriction && (
              <Textarea
                ...
                placeholder="Detalhes da restrição..."
    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-pink-600 hover:bg-pink-700 h-7 text-xs px-2"
        >
      ...
      <div className="space-y-1.5">
        {children.map((child) => (
          <Card key={child.id} className="border border-pink-100">
            <CardContent className="p-2">
              <div className="space-y-1">
                ...
                {child.parent_contact?.name && (
                  <p className="text-xs text-gray-600">
                    Pais: {child.parent_contact.name}
                  </p>
                )}

                {(child.is_autistic || child.has_food_restriction) && (
                  <div className="flex gap-1 mt-1">
                    {child.is_autistic && (
                      <span className="flex items-center gap-1 px-1.5 py-0.5 bg-yellow-100 text-yellow-800 rounded text-xs">
                    ...
                    {child.has_food_restriction && (
                      <span 
                        className="flex items-center gap-1 px-1.5 py-0.5 bg-orange-100 text-orange-800 rounded text-xs cursor-help"
